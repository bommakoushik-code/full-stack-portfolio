  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://full-stack-portfolio-qp1x.onrender.com/api/contact",
        {
          method: "POST",
          headers: {
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <aside className="w-full lg:w-64 lg:min-h-screen border-b lg:border-b-0 lg:border-r border-purple-900/30 p-6 lg:p-8">
          ...
          <div className="bg-[#151022] rounded-2xl p-5 mb-8 border border-purple-900/30">
            ...
            <h2 className="mt-4 text-2xl font-bold">Koushik Bomma</h2>
        ...
        <main className="flex-1 p-6 lg:p-12 space-y-12 overflow-hidden">
          ...
          <div
            id="overview"
            className="rounded-3xl bg-gradient-to-r from-purple-950 to-[#1A1235] p-8 lg:p-10 border border-purple-900/30 shadow-2xl"
          >
            ...
            <p className="text-gray-400 mt-6 max-w-2xl text-lg leading-relaxed">
              Full Stack Developer specializing in React, Node.js, Express, and
              MongoDB. I build scalable web applications with clean architecture,
              responsive design, and a strong focus on performance and user
              experience.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="#projects"
                className="inline-flex items-center justify-center bg-purple-600 px-6 py-3 rounded-xl hover:bg-purple-700 transition duration-300 shadow-lg"
              >
                View Projects
              </a>
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center border border-purple-500 px-6 py-3 rounded-xl hover:bg-purple-900 transition"
              >
                Contact Me
              </a>
              ...
              <a
                href="/resume.pdf"
                target="_blank"
                className="inline-flex items-center justify-center bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition"
              >
                Resume
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="bg-[#151022] p-6 rounded-2xl border border-purple-900/30 hover:border-purple-500 hover:scale-105 transition duration-300 shadow-lg">
              <h2 className="text-3xl font-bold text-purple-400">Full‑Stack</h2>
              <p className="text-gray-400 mt-2">Development</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-[#151022] p-6 rounded-2xl border border-purple-900/30 hover:border-purple-500 hover:-translate-y-2 transition duration-300">
                ...
                <p className="text-gray-400 mt-3 leading-relaxed">
                  Full‑stack portfolio built using React, Tailwind CSS,
                  Express.js and MongoDB Atlas. Demonstrates a responsive design,
                  dynamic contact form integration and live deployment on
                  Render/Vercel.
                </p>
                {/* Tech stack badges */}
                ...
                <div className="flex flex-wrap gap-3 mt-5">
                  <a
                    ...
                    target="_blank"
                    className="inline-flex items-center justify-center min-w-24 bg-purple-600 px-4 py-2 rounded-lg hover:bg-purple-700 transition"
                  >
                    GitHub
                  </a>
                    <a
                      ...
                      target="_blank"
                      className="inline-flex items-center justify-center min-w-24 border border-purple-500 px-4 py-2 rounded-lg hover:bg-purple-900 transition"
                    >
                      Live Demo
                    </a>
                </div>
              </div>
              {/* Project Card: Student Management System */}
              <div className="bg-[#151022] p-6 rounded-2xl border border-purple-900/30 hover:border-purple-500 hover:-translate-y-2 transition duration-300">
                <h3 className="text-lg font-semibold">
                ...
                <p className="text-gray-400 mt-3 leading-relaxed">
                  ...
                  attendance and academic information using a database‑driven
                  backend. Implements CRUD operations with secure API endpoints
          ...
          <div id="experience" className="mt-12">
            ...
            <div className="space-y-6">
              {/* Highlight 1: Portfolio Project */}
              <div className="bg-[#151022] p-5 rounded-2xl border border-purple-900/30">
                <h3 className="text-purple-400 font-semibold">
                  🏆 Portfolio Project
                </h3>
                <p className="mt-2 leading-relaxed">
                  Designed and developed a full‑stack portfolio using React,
                  Tailwind CSS, Express.js and MongoDB. Implemented responsive
                  layout, a dynamic contact form and deployment on
                  Vercel/Render.
                </p>
              </div>
              {/* Highlight 2: Student Management System */}
              <div className="bg-[#151022] p-5 rounded-2xl border border-purple-900/30">
                <h3 className="text-purple-400 font-semibold">
                  📚 Student Management System
                </h3>
                <p className="mt-2 leading-relaxed">
                  Built a CRUD application for managing student records with
                  Node.js, Express and MongoDB. Implemented secure REST APIs,
                  authentication and a clean dashboard UI.
                </p>
              </div>
              {/* Highlight 3: Ongoing Learning */}
              <div className="bg-[#151022] p-5 rounded-2xl border border-purple-900/30">
                <h3 className="text-purple-400 font-semibold">
                  🚀 Ongoing &amp; Future
                </h3>
                <p className="mt-2 leading-relaxed">
                  Continuing to expand full‑stack skills by exploring advanced
                  frameworks, cloud services, and building new projects that
                  push the boundaries of user experience and scalability.
                </p>
              </div>
            </div>
          </div>
          ...
          <footer className="mt-20 text-center text-gray-500 border-t border-purple-900/30 pt-6">
            © 2026 Koushik Bomma. Built with React, Tailwind CSS, Express &
            MongoDB.
          </footer>
        </main>
      </div>
